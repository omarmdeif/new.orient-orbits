<nav class="relative bg-white border-b-2 border-gray-300 text-gray-900">
  <div class="container mx-auto flex justify-between">
    <div class="relative block p-4 lg:p-6 text-xl text-blue-600 font-bold">
      ...
      <a href="/" class="relative block p-3 text-gray-300 hover:text-white"><img src="{{ asset('Images/oh-logo.png') }}" alt=""></a>
    ...
    <ul class="flex">
      ...
      <li class="hover:bg-blue-800 hover:text-white">
        <a href="services" class="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold">Our Services</a>
      </li>
      <li class="hover:bg-blue-800 hover:text-white">
        <a href="contact" class="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold">Contact Us</a>
      </li>
      <li class="hover:bg-blue-800 hover:text-white">
        <a href="about" class="relative block py-6 px-2 lg:p-6 text-sm lg:text-base font-bold">About Us</a>
      </li>
