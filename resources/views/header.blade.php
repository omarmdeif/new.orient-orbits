        ...
        <div
          ...
          <ul
            ...
            <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
                ...
                <a src="{{ asset('Images/logo.svg') }}" class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:hover:text-white dark:focus:text-white lg:p-2 [&.active]:text-black/90"></a>
              </li>
            <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
              <a
